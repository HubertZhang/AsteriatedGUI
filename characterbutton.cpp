...
: PicButton(GEO_CHARACTER_X[place],GEO_CHARACTER_Y[place],GEO_CHARACTER_W,GEO_CHARACTER_H,true,parent)
{
    ...
    clickedLabel.setPixmap(QPixmap(QString(":/character/character%1.png").arg(QString::number(character,2))));
    notClickedLabel.setPixmap(QPixmap(QString(":/character/character%1.png").arg(QString::number(character,2))));
